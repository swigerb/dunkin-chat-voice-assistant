...
echo "AZURE_OPENAI_EASTUS2_ENDPOINT=$(azd env get-value AZURE_OPENAI_EASTUS2_ENDPOINT)" >> $ENV_FILE_PATH
...
echo "AZURE_SEARCH_SEMANTIC_RANKER=$(azd env get-value AZURE_SEARCH_SEMANTIC_RANKER)" >> $ENV_FILE_PATH
